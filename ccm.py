...
DIGITAL_DESCRIPTIONS = {
    ...
    "dvlProtLed": "Elevato gradiente di tensione di linea",
    "dvfProtLed2": "Doppio gradiente elevato di tensione di filtro",
    "dvlProtLed2": "Doppio gradiente elevato di tensione di linea",
    "koThCHPIND1": "Spegnimento CCM: misura errata di temperatura dell'induttanza di fase 1",
    "koThCHPIND2": "Spegnimento CCM: misura errata di temperatura dell'induttanza di fase 2",
    "koThINTAIR": "Spegnimento CCM: misura errata di temperatura dell'aria interna",
    "koThHEATSINK": "Spegnimento CCM: misura errata di temperatura del dissipatore",
    "PcuKO": "Spegnimento CCM: comunicazione con PCU assente",
    "pswCHPIND1_HOTMAX": "Spegnimento CCM: sovra-temperatura induttore fase 1",
    "pswUNDERVOLTPRIM": "Spegnimento CCM: bassa tensione DC-Link primario (conf. 1.5kV)",
    "pswOPENFAILBYS": "Spegnimento CCM: incongruenza stato del contattore di bypass",
    "pswCHPIND2_HOTMAX": "Spegnimento CCM: sovra-temperatura induttore fase 2",
    ...
    "pswkoTA": "Spegnimento CCM: misura errata della corrente di linea",
    "UNDERVOLTLINE3K": "Spegnimento CCM: tensione di linea DC fuori range (conf. 3 kV)",
    "pswINCALTI": "Spegnimento CCM: incongruenza stato del contattore di bypass",
    "DISCHA_FAIL": "Spegnimento CCM: scarica filtri non riuscita",
    "HEATSINK_HOTMAX": "Spegnimento CCM: sovra-temperatura dissipatore",
    "pswCLOSEFAILBY": "Spegnimento CCM: mancata chiusura del contattore di bypass",
    "TASUPERV": "Spegnimento CCM: misura errata della corrente di linea",
    "CCMESCL": "CCM escluso",
    "CHARGESUPERV": "Spegnimento CCM: pre-carica del filtro DC-Link primario non riuscita",
    "OVPRESHOT": "Spegnimento CCM: sovratemperatura della resistenza di OVP",
    "TEMPSCHEDHOT": "Spegnimento CCM: sovratemperatura della scheda elettronica NPC della MOCU/C",
    ...
    "TA2": "Spegnimento CCM: sovra-corrente della fase 2",
    ...
    "DiaUp3": "Spegnimento CCM: diagnostica di fase chopper OVP fase A IGBT ALTO",
    "DiaUp4": "Spegnimento CCM: diagnostica di fase chopper OVP fase B IGBT ALTO",
    "DiaUp5": "Diagnostica UP 5",
    "DiaDown1": "Spegnimento CCM: diagnostica di fase 1 IGBT BASSO",
    "DiaDown2": "Spegnimento CCM: diagnostica di fase 2 IGBT BASSO",
...
def ccm_page():
    ...
    try:
        ...
        st.error(f"Errore nella lettura del file CCM: {error}")
        return
    ...
    if not filtered_summary:
        st.warning("Nessun evento trovato nella descrizione.")
        return
    ...
    ll_rows = ll_blocks.get(selected_rec, [])
    ...
    if selected_summary:
        description = str(selected_summary[-1]).strip()

        if description:
            st.caption(f"Descrizione: {description}")
    ...
    st.session_state["ccm_current_index"] = current_index
